# notification-component chart

The Helm chart installs notification-component and by default the following dependencies using subcharts:
...
```bash
helm repo add notification-component https://raw.githubusercontent.com/ConductionNL/notification-component/master/api/helm/
helm repo update
```
...
```bash
helm install my-notification-component ConductionNL/notification-component --version 0.1.0
```
...
| `settings.subdomain` | the subdomain of the installation excluding www. | `notification-component` |
| `settings.subpath` | Any sub path to follow the domain, like /api/v1 | `notification-component` |
